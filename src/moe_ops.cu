...
void fused_dispatch_grouped_gemm_swiglu(
  ...
  ::fused_dispatch_grouped_gemm_swiglu(
      ...
      expert_to_token_map, expert_to_slot_map, padded_expert_counts,
      src_token_idx, src_dev_idx, src_slot_idx, barrier, num_tokens,
      num_recv_tokens, dp_rank, rank, dp_size, cur_dp_group, num_dp_groups,
      world_size, num_experts, experts_per_token, num_comm_sms, num_comp_sms,
      stream);
}
