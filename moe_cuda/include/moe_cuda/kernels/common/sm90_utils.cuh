...
//   template <size_t... Idx>
//   __forceinline__ __device__ static void call_fma_impl(uint64_t const
//   &desc_a, uint64_t const &desc_b, float *d,
//                                                        bool scale_d,
//                                                        cute::index_sequence<Idx...>)
//                                                        {
//     using namespace cute::SM90::GMMA;
//     MMA::fma(desc_a, desc_b, d[Idx]..., (scale_d ? ScaleOut::One :
//     ScaleOut::Zero));
//   }

//   __forceinline__ __device__ static void wgmma(uint64_t const &desc_a,
//   uint64_t const &desc_b, float *d, bool scale_d) {
//     call_fma_impl(desc_a, desc_b, d, scale_d, cute::make_index_sequence<N_ /
//     2>{});
//   }
...
//   // kNumAccum - 128 describes the number of FP32 accum registers used per
//   WGMMA
//   // tile, and this is a fixed bound because of per SM register capacities.
//   So
...
//   static constexpr auto select_type() { return FP8MMA<N,
//   decltype(select_mma())>(); }
...
//   CUTE_STATIC_ASSERT(kMajor == Major::K or kMajor == Major::MN, "Invalid
//   major-ness"); return kMajor == Major::K ? cute::SM90::GMMA::Major::K :
...
//     if constexpr (N == 8)
//       return MMA_64x8x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 16)
//       return MMA_64x16x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 24)
//       return MMA_64x24x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 32)
//       return MMA_64x32x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 40)
//       return MMA_64x40x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 48)
//       return MMA_64x48x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 56)
//       return MMA_64x56x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 64)
//       return MMA_64x64x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 72)
//       return MMA_64x72x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 80)
//       return MMA_64x80x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 88)
//       return MMA_64x88x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 96)
//       return MMA_64x96x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 104)
//       return MMA_64x104x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 112)
//       return MMA_64x112x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 120)
//       return MMA_64x120x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 128)
//       return MMA_64x128x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 136)
//       return MMA_64x136x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 144)
//       return MMA_64x144x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 152)
//       return MMA_64x152x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 160)
//       return MMA_64x160x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 168)
//       return MMA_64x168x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 176)
//       return MMA_64x176x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 184)
//       return MMA_64x184x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 192)
//       return MMA_64x192x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 200)
//       return MMA_64x200x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 208)
//       return MMA_64x208x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 216)
//       return MMA_64x216x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 224)
//       return MMA_64x224x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 232)
//       return MMA_64x232x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 240)
//       return MMA_64x240x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 248)
//       return MMA_64x248x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//     if constexpr (N == 256)
//       return MMA_64x256x16_F32BF16BF16_SS<kGMMAMajorA, kGMMAMajorB,
//       kScaleIn>();
//   }

//   static constexpr auto select_type() { return BF16MMA<N,
//   decltype(select_mma())>(); }
...
//   template <size_t... Idx>
//   __forceinline__ __device__ static void call_fma_impl(uint32_t const &a00,
//   uint32_t const &a01, uint32_t const &a02,
//                                                        uint32_t const &a03,
//                                                        uint64_t const
//                                                        &desc_b, float *d,
//                                                        bool scale_d,
...
//                                                        {
//     using namespace cute::SM90::GMMA;
//     MMA::fma(a00, a01, a02, a03, desc_b, d[Idx]..., (scale_d ? ScaleOut::One
//     : ScaleOut::Zero));
//   }

//   __forceinline__ __device__ static void wgmma(uint32_t const &a00, uint32_t
//   const &a01, uint32_t const &a02,
//                                                uint32_t const &a03, uint64_t
//                                                const &desc_b, float *d, bool
//                                                scale_d) {
//     call_fma_impl(a00, a01, a02, a03, desc_b, d, scale_d,
...
//   static constexpr auto select_mma() {
//     using namespace cute::SM90::GMMA;
//     constexpr auto kGMMAMajorA = cute::SM90::GMMA::Major::K; // RS atoms
//     require A to be K-major constexpr auto kGMMAMajorB =
//     to_sm90_major<kMajorB>(); if constexpr (N == 8)
...
//   static constexpr auto select_type() { return BF16MMARS<N,
//   decltype(select_mma())>(); }
...
// CUTLASS_DEVICE bool is_same_row_or_col(int dst_block_id, dim3 block_id,
...
// template <class ClusterShape>
// CUTLASS_DEVICE void setup_multicast_wgmma_threads(bool &signalling_thread,
// uint32_t &dst_cta_id, int warp_idx,
//                                                   ClusterShape cluster_shape)
//                                                   {
//   auto [signalling_thread_, dst_cta_id_] =
//   cutlass::detail::spread_arrivals_to_warpgroup(threadIdx.x % 128, warp_idx);
//   signalling_thread = signalling_thread_;
//   dst_cta_id = dst_cta_id_;
//   signalling_thread &= dst_cta_id < size(cluster_shape);
//   signalling_thread &= is_same_row_or_col(dst_cta_id,
//   cute::block_id_in_cluster(), cluster_shape);
// }

// // following DeepGEMM, custom TMA copy dispatch - only one thread should call
// in
// // a single CTA
// // Use void const* instead of CUtensorMap* to avoid cuda.h dependency
// template <int BLOCK_INNER, int BLOCK_OUTER, size_t SWIZZLE_SIZE, typename
// tdtype_t, int NDIM = 2>
// __device__ __forceinline__ void tma_copy(void const *tensor_map,
// cutlass::arch::ClusterTransactionBarrier *barrier,
//                                          tdtype_t *smem_addr, uint32_t
//                                          inner_idx, uint32_t outer_idx, int
//                                          num_multicast, uint32_t crd2_idx =
//                                          0, uint32_t crd3_idx = 0, uint32_t
//                                          crd4_idx = 0) {
//   int swizzle_atom_size = BLOCK_INNER;
//   if (SWIZZLE_SIZE > 0) {
//     swizzle_atom_size = SWIZZLE_SIZE /
//     cutlass::bits_to_bytes(cutlass::sizeof_bits<tdtype_t>::value);
//   }
...
//           cute::SM90_TMA_LOAD_MULTICAST_1D::copy(tensor_map,
//           reinterpret_cast<uint64_t *>(barrier),
//                                                  (1 << num_multicast) - 1,
//                                                  static_cast<uint64_t>(cute::TMA::CacheHintSm90::EVICT_NORMAL),
//                                                  smem_addr + i +
//                                                  swizzle_atom_size, inner_idx
//                                                  + i * swizzle_atom_size);
//         }
//       }
//     } else {
//       for (int i = 0; i < BLOCK_INNER / swizzle_atom_size; i++) {
//         cute::SM90_TMA_LOAD_1D::copy(tensor_map, reinterpret_cast<uint64_t
//         *>(barrier),
//                                      static_cast<uint64_t>(cute::TMA::CacheHintSm90::EVICT_NORMAL),
//                                      smem_addr + i + swizzle_atom_size,
//                                      inner_idx + i * swizzle_atom_size);
//       }
//     }
//   }
...
//     if (num_multicast == 1) {
//       for (int i = 0; i < BLOCK_INNER / swizzle_atom_size; i++) {
//         cute::SM90_TMA_LOAD_2D::copy(tensor_map, reinterpret_cast<uint64_t
//         *>(barrier),
//                                      static_cast<uint64_t>(cute::TMA::CacheHintSm90::EVICT_NORMAL),
//                                      smem_addr + i * swizzle_atom_size *
//                                      BLOCK_OUTER, inner_idx + i *
//                                      swizzle_atom_size, outer_idx);
//       }
//     } else {
//       for (int i = 0; i < BLOCK_INNER / swizzle_atom_size; i++) {
//         if (cute::block_rank_in_cluster() == 0) {
//           cute::SM90_TMA_LOAD_MULTICAST_2D::copy(
//               tensor_map, reinterpret_cast<uint64_t *>(barrier), (1 <<
//               num_multicast) - 1,
//               static_cast<uint64_t>(cute::TMA::CacheHintSm90::EVICT_NORMAL),
//               smem_addr + i * swizzle_atom_size * BLOCK_OUTER, inner_idx + i
//               * swizzle_atom_size, outer_idx);
//         }
//       }
//     }
...
//     if (num_multicast == 1) {
//       for (int i = 0; i < BLOCK_INNER / swizzle_atom_size; i++) {
//         cute::SM90_TMA_LOAD_3D::copy(tensor_map, reinterpret_cast<uint64_t
//         *>(barrier),
//                                      static_cast<uint64_t>(cute::TMA::CacheHintSm90::EVICT_NORMAL),
//                                      smem_addr + i * swizzle_atom_size *
//                                      BLOCK_OUTER, inner_idx + i *
//                                      swizzle_atom_size, outer_idx, crd2_idx);
//       }
//     } else {
//       for (int i = 0; i < BLOCK_INNER / swizzle_atom_size; i++) {
//         if (cute::block_rank_in_cluster() == 0) {
...
//     if (num_multicast == 1) {
//       for (int i = 0; i < BLOCK_INNER / swizzle_atom_size; i++) {
//         cute::SM90_TMA_LOAD_4D::copy(tensor_map, reinterpret_cast<uint64_t
//         *>(barrier),
//                                      static_cast<uint64_t>(cute::TMA::CacheHintSm90::EVICT_NORMAL),
//                                      smem_addr + i * swizzle_atom_size *
//                                      BLOCK_OUTER, inner_idx + i *
...
//       for (int i = 0; i < BLOCK_INNER / swizzle_atom_size; i++) {
//         if (cute::block_rank_in_cluster() == 0) {
//           cute::SM90_TMA_LOAD_MULTICAST_4D::copy(tensor_map,
//           reinterpret_cast<uint64_t *>(barrier),
//                                                  (1 << num_multicast) - 1,
//                                                  static_cast<uint64_t>(cute::TMA::CacheHintSm90::EVICT_NORMAL),
//                                                  smem_addr + i *
...
//   CUTE_STATIC_ASSERT(kSwizzleMode == 0 || kSwizzleMode == 16 || kSwizzleMode
//   == 32 || kSwizzleMode == 64 ||
//                      kSwizzleMode == 128);
...
// template <Major kMajor, uint32_t BLOCK_MN, uint32_t BLOCK_K, uint32_t
// kSwizzleMode, typename dtype_t>
// __device__ __forceinline__ uint32_t get_gmma_desc_stride_k() {
//   return kMajor == Major::K ? 1 : get_block_atom_inner_size<BLOCK_MN,
...
// CUTE_DEVICE cute::GmmaDescriptor make_smem_desc(dtype_t *smem_ptr, uint32_t
// layout_type, uint32_t LBO, uint32_t SBO) {
//   cute::GmmaDescriptor desc;
//   const auto &uint_ptr =
//   static_cast<uint32_t>(__cvta_generic_to_shared(smem_ptr));
//   desc.bitfield.base_offset_ = 0; // assuming that smem_ptr is 1024 aligned -
//   this is a little dangerous desc.bitfield.start_address_ = uint_ptr >> 4;
...
// template <Major kMajor, uint32_t BLOCK_MN, uint32_t BLOCK_K, uint32_t
// kSwizzleMode, typename dtype_t>
// __device__ __forceinline__ cute::GmmaDescriptor create_wgmma_desc(dtype_t
// *smem_ptr) {
//   // mn_idx here is the
//   const uint32_t k_stride = (kMajor == Major::K) ? 1 :
//   get_block_atom_inner_size<BLOCK_MN, kSwizzleMode, dtype_t>(); const auto
//   &layout_type = get_layout<kSwizzleMode>();
...
//                        "BLOCK_K * sizeof(dtype_t) should be equal to
//                        kSwizzleMode");

//     // CUTE_STATIC_ASSERT(kSwizzleMode == BLOCK_K * sizeof(dtype_t), "There
//     should only be one atom in the K
//     // direction"); SBO, LBO : for K major, stride between atoms on MN, K
//     resp. since we enforce only one atom in K
...
//     constexpr uint32_t BLOCK_K_ATOM = get_block_atom_inner_size<BLOCK_K,
//     kSwizzleMode, dtype_t>(); const uint32_t SBO = 8 * BLOCK_K_ATOM *
//     sizeof(dtype_t);
//     // const uint32_t LBO = BLOCK_MN * kSwizzleMode;

//     return make_smem_desc(smem_ptr, static_cast<uint32_t>(layout_type), LBO,
//     SBO);
//   } else {
...
//     // {SBO, LBO} means the byte stride between atoms on {K, MN} for
//     swizzling
//     // {SBO, LBO} means the byte stride between atoms on {MN, K} for
//     // non-swizzling
//     constexpr uint32_t BLOCK_MN_ATOM = get_block_atom_inner_size<BLOCK_MN,
//     kSwizzleMode, dtype_t>(); const int num_swizzle_atoms = BLOCK_MN /
//     (kSwizzleMode / sizeof(dtype_t));
//     // uint32_t SBO = 8 * kSwizzleMode * num_swizzle_atoms;
//     uint32_t SBO = 8 * BLOCK_MN_ATOM * sizeof(dtype_t);
//     uint32_t LBO = BLOCK_K * BLOCK_MN_ATOM * sizeof(dtype_t); // offset by
//     entire chunk if constexpr (kSwizzleMode == 16) {                       //
//     no swizzling, but interleave means swap
//       uint32_t temp = SBO;
//       SBO = LBO;
//       LBO = temp;
//     }
...
//   ::"l"(__cvta_generic_to_shared(ptr)), "r"(val.x),
//                "r"(val.y), "r"(val.z), "r"(val.w));
// }

// CUTE_DEVICE float ld_shared(float *ptr) {
//   float ret;
//   asm volatile("{ ld.shared.f32 %0, [%1]; }" : "=f"(ret) :
//   "l"(__cvta_generic_to_shared(ptr)) : "memory"); return ret;
// }
...
//   uint32_t ret;
//   asm volatile("{ ld.shared.u32 %0, [%1]; }" : "=r"(ret) :
//   "l"(__cvta_generic_to_shared(ptr)) : "memory"); return
//   *reinterpret_cast<__nv_bfloat162 *>(&ret);
// }

// CUTE_DEVICE __nv_bfloat16 ld_shared(__nv_bfloat16 *ptr) {
//   uint16_t ret;
//   asm volatile("{ ld.shared.u16 %0, [%1]; }" : "=h"(ret) :
//   "l"(__cvta_generic_to_shared(ptr)) : "memory"); return
//   __short_as_bfloat16(ret);
//   ;
// }
...
//     *reinterpret_cast<uint32_t *>(&src_1)}; asm volatile(
...
// // Load bf16 data from swizzled shared memory into float accumulator
// registers.
// // This assumes a single swizzle atom (BLOCK_INNER * sizeof(bf16) ==
// kSwizzleMode for K-major layouts).
// // Template params:
// //   BLOCK_INNER: number of elements in the inner (K) dimension
// //   kSwizzleMode: swizzle mode in bytes (0 for non-swizzled, 32/64/128 for
// swizzled)
...
// uint32_t WGMMA_M_PER_WARP>
// __device__ __forceinline__ void load_swizzled_smem_to_accum(__nv_bfloat16
// *smem_ptr, float *accum, int warp_idx,
//                                                             int lane_idx) {
...
//     uint8_t *ptr = nullptr;
//     if constexpr (kSwizzleMode > 0) {
//       constexpr uint32_t kSwizzleAtomSize = kSwizzleMode /
//       sizeof(__nv_bfloat16); // elements per swizzle atom int atom_offset =
//       col_idx / (kSwizzleAtomSize / 8); int in_atom_offset = col_idx %
//       (kSwizzleAtomSize / 8); int bank_group_index = in_atom_offset +
//       lane_idx * (kSwizzleMode / kNumBankGroupBytes); int row =
//       bank_group_index / 8, col = bank_group_index % 8; col ^= row %
//       (kSwizzleMode / 16);
//       // Reshape layout from (BLOCK_M, kSwizzleMode / kNumBankGroupBytes) to
//       // (BLOCK_M * kSwizzleMode / kNumBankGroupBytes / 8, 8) to match TMA
//       128B line layout ptr = reinterpret_cast<uint8_t *>(smem_ptr) +
//       WGMMA_M_PER_WARP * warp_idx * kSwizzleMode +
//             atom_offset * BLOCK_OUTER * kSwizzleMode + row *
//             (kNumBankGroupBytes * 8) + col * kNumBankGroupBytes;
//     } else {
//       ptr =
//           reinterpret_cast<uint8_t *>(smem_ptr + (WGMMA_M_PER_WARP * warp_idx
//           + lane_idx) * BLOCK_INNER + col_idx * 8);
//     }
//     const uint2 data = custom_SM90_U32x2_STLM_N::load(ptr);
//     __nv_bfloat162 bf16_pair1 = *reinterpret_cast<const __nv_bfloat162
//     *>(&data.x);
//     __nv_bfloat162 bf16_pair2 = *reinterpret_cast<const __nv_bfloat162
//     *>(&data.y);
...
// //   BLOCK_OUTER: number of elements in the outer (M) dimension (for atom
// stride calculation)
// //   kSwizzleMode: swizzle mode in bytes (0 for non-swizzled, 32/64/128 for
// swizzled)
// //   WGMMA_M_PER_WARP: rows per warp (typically MMA::M / 4 = 16)
// template <uint32_t BLOCK_INNER, uint32_t BLOCK_OUTER, uint32_t kSwizzleMode,
// uint32_t WGMMA_M_PER_WARP>
// __device__ __forceinline__ void store_accum_to_swizzled_smem(float *accum,
// __nv_bfloat16 *smem_ptr, int warp_idx,
//                                                              int lane_idx) {
//   constexpr uint32_t kNumBankGroupBytes = 16;
//   constexpr uint32_t kNumIter = BLOCK_INNER / 8; // Each iteration handles 8
//   elements (4 accum values * 2 bf16)
// #pragma unroll
//   for (int i = 0; i < kNumIter; i++) {
//     uint8_t *ptr = nullptr;
//     if constexpr (kSwizzleMode > 0) {
//       constexpr uint32_t kSwizzleAtomSize = kSwizzleMode /
//       sizeof(__nv_bfloat16); // elements per swizzle atom int atom_offset = i
//       / (kSwizzleAtomSize / 8); int in_atom_offset = i % (kSwizzleAtomSize /
//       8); int bank_group_index = in_atom_offset + lane_idx * (kSwizzleMode /
//       kNumBankGroupBytes); int row = bank_group_index / 8, col =
//       bank_group_index % 8; col ^= row % (kSwizzleMode / 16); // ptr =
//       reinterpret_cast<uint8_t *>(smem_ptr) + atom_offset * BLOCK_OUTER *
//       kSwizzleMode +
//             WGMMA_M_PER_WARP * kSwizzleMode * warp_idx + row *
//             (kNumBankGroupBytes * 8) + col * kNumBankGroupBytes;
//     } else {
//       ptr = reinterpret_cast<uint8_t *>(smem_ptr + (WGMMA_M_PER_WARP *
//       warp_idx + lane_idx) * BLOCK_INNER + i * 8);
//     }
//     custom_SM90_U32x2_STSM_N<__nv_bfloat162>::copy(__float22bfloat162_rn({accum[i
//     * 4 + 0], accum[i * 4 + 1]}),
//                                                    __float22bfloat162_rn({accum[i
//                                                    * 4 + 2], accum[i * 4 +
//                                                    3]}), ptr);
//   }
