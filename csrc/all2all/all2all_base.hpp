...
public:
  ...
  virtual void dispatch(torch::stable::Tensor &out_expert_num_tokens,
                        torch::stable::Tensor &out_expert_x,
                        std::optional<torch::stable::Tensor> &out_expert_x_scale,
                        torch::stable::Tensor &dp_x, std::optional<torch::stable::Tensor> &dp_x_scale,
  ...
  virtual void combine(torch::stable::Tensor &out_tokens, torch::stable::Tensor &indices,
...
void naive_moe_forward_dispatch(
    ...
    torch::stable::Tensor &out_tokens, torch::stable::Tensor &expert_x, torch::stable::Tensor &expert_x_scales,
    torch::stable::Tensor &inter_y, torch::stable::Tensor &inter_y_scales, torch::stable::Tensor &expert_y,
    cudaStream_t stream);
