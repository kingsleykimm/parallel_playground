...
void bind_fused_dispatch_grouped_gemm_swiglu(pybind11::module_& m) {
  m.def(
      ...
      [](kittens::py::TKParallelTensor &in_tokens,
         ...
         int dp_size, int cur_dp_group, int num_dp_groups, int num_experts,
        ...
        moe_cuda::kernels::fused_dispatch_grouped_gemm_swiglu(
            ...
            indices, global_num_routed, expert_to_token_map,
            padded_expert_counts, src_token_idx, src_dev_idx, barrier,
            num_tokens, num_recv_tokens, dp_rank, rank, dp_size, cur_dp_group,
            num_dp_groups, num_experts, experts_per_token, num_comm_sms,
            num_comp_sms, stream);
      },
      pybind11::arg("in_tokens"), pybind11::arg("in_tokens_scales"),
      pybind11::arg("expert_x_tokens"), pybind11::arg("expert_x_tokens_scale"),
      pybind11::arg("comm_comp_barrier"), pybind11::arg("gate"),
      pybind11::arg("up"), pybind11::arg("C"), pybind11::arg("scale_gate"),
      pybind11::arg("scale_up"), pybind11::arg("out_scales"),
      pybind11::arg("indices"), pybind11::arg("global_num_routed"),
      pybind11::arg("expert_to_token_map"),
